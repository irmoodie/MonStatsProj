...
rosette_mod <- lmer(Rosette_size~light+species+time_after_germ+light:species+light:time_after_germ+Cotyledons+(1+species|population), data = rosette_data)

rosette_mod1 <- lm(Rosette_size~light+species+time_after_germ+light:species+light:time_after_germ+Cotyledons, data = rosette_data)
summary(rosette_mod1)
